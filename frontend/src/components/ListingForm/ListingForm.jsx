...
const ListingForm = ({ resultAddress, coordinates }) => {
  ...
  const [sqmt, setSqmt] = useState(listing.sqmt);
  ...
  const handleSubmit = async (e) => {
    ...
    const priceSqmt = (price / sqmt).toFixed(2);
    ...
    formData.append("listing[sqmt]", sqmt);
    ...
    formData.append("listing[price_sqmt]", priceSqmt);
    ...
    <>
      ...
      <div className="form-container">
        <form onSubmit={handleSubmit}>
          ...
          <p className="warning">
            Post once and your home will be listed on both Villow and Trulia,
            reaching buyers on the largest real estate network on the Web. Plus,
            home shoppers receive emails about new homes on the market –
            including yours.
          </p>
          <hr />
            ...
            <div className="photos-wrapper">
              <div className="attach-photos">
                ...
                <input
                  ...
                  value="Add New Photo"
                  onClick={() => {
                    document.getElementsByClassName("photo-input")[0].click();
                  }}
                />
                <br />
              </div>
              {Array.from(photoFiles).length !== 0 ? (
                <div className="photo-preview">
                  {Array.from(photoFiles).map((photo, idx) => (
                    <div
                      key={idx}
            ...
            <div className="quad">
              ...
              <label>
                ...
                <input
                  ...
                  placeholder="0"
                  value={sqmt}
                  onChange={(e) => setSqmt(e.target.value)}
                />
              </label>
              <label>
                Year built
            ...
            <label className="terms">
              <div className="inner-check">
                <input
                  ...
                  className="agreement"
                />
                I agree to, acknowledge and understand the following: (i) I am
                (or I have authority to act on behalf of) the owner of this
                home; (ii) I will not provide incorrect information or state a ;
                (iii) I will be posting my property 'for sale by owner' on
                villow.com and other affiliated websites and that I will solely
                ...
                property; (iv) Villow, Inc. ("Villow") is a licensed real estate
                brokerage, that I am not entering into any agency or brokerage
                relationship with Villow as part of this posting and that Villow
                is not providing me with any real estate brokerage services as
                part of this posting; and (v) I will comply with the Villow
                Terms of Use and Listing Quality Policy I also agree that by
                clicking below, Villow Group and its affiliates, and real estate
                professionals
                <div>
                  <p>
                    "Real estate professionals" includes the real estate agents
                    and brokers, mortgage lenders and loan officers, property
                    managers and other professionals you interact with through
                    Villow. Villow Premier Agent is an advertising program that
                    helps connect customers to local real estate professionals.
                    Villow Premier Agent partners are paid advertisers and are
                    not affiliated with Villow, Inc. brokerage or any of its
                    affiliates.
                  </p>
                  may call or text me for marketing purposes, which may involve
                  use of automated means and prerecorded/artificial voices.
                  Consent is not a condition of buying any property, goods or
